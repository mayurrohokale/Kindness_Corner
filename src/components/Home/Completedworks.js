...
export default function Completedworks(){
    ...
    return(
        <div className="mt-6  max-w-full mx-2  h-full bg-gradient-to-b from-[#90CAF9] to-[#276AA0] " id="works">
            <div className="justify-start pt-20 pb-8">
            <p className=" justify-center md:justify-start font-bold text-[40px] md:text-[55px] font-josiefin ">Completed <span className="bg-[#E91E63] p-3 text-white">Works</span> </p>
