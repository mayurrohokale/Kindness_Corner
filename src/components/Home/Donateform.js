    ...
    return(
        <div className="bg-[#F6F2F2] flex flex-col w-full sm:w-[493px] max-w-[493px] rounded-[25px]">
            ...
            <div className="mt-2 relative">
                <input type="number" name="amount" className="border border-black w-[419px] h-[71px] hover:shadow-lg 
                " 
            />
            <button className="w-[260px] h-[70px] items-center  bg-[#E91E63] text-white text-[25px] font-bold mt-10 mb-2 shadow-lg font-inter hover:scale-110">DONATE NOW</button>
            </div>
            <div className="flex flex-row items-center justify-center mt-10 gap-8 mb-8 ">
                ...
                <img src="./images/visa.png" className="w-[60px] h-[55px]" alt="visa"/>
            </div>
        </div>
    )
}