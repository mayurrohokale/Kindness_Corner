...
export default function Donateform(){
    return(
        <div className="bg-[#F6F2F2] flex flex-col sm:w-[493px] max-w-[493px]  rounded-[25px] border border-black md:border-none shadow-lg">
            ...
            <p className="flex justify-start px-10 py-2 text-[10px] md:text-[12px] text-[#E91E63] font-itim mt-2 mb-1">Monthly gifts help save lives all years long
            ...
            <div className=" mt-4 md:mt-2 relative">
                ...
                " 
            />
            <button className=" w-[150px] h-[48px] md:w-[260px] md:h-[70px] items-center  bg-[#E91E63] text-white text-[15px] md:text-[25px] font-bold mt-10 mb-2 shadow-lg font-inter hover:scale-110">DONATE NOW</button>
            </div>
